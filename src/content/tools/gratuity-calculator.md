---
title: "Gratuity Calculator: Payment of Gratuity Act Amount & Tax Exemption"
metaDescription: "Calculate statutory gratuity payout under Payment of Gratuity Act 1972. Estimate tax-free gratuity exemption under Section 10(10) up to ₹20 Lakhs."
category: "retirement"
...
benefits:
  ...
  - "Verify corporate HR gratuity settlement figures against official statutory labor laws"
  - "Understand tax-free limits under Section 10(10) to avoid surprise tax liabilities"
  - "Plan post-job separation liquid cash flow and retirement reinvestment"
faqs:
  ...
  - question: "Can an employer forfeit an employee's gratuity?"
    answer: "Gratuity can be forfeited partially or wholly ONLY if an employee's services are terminated for disorderly conduct, violence, moral turpitude, or causing financial loss to the employer due to willful omission or negligence, as per Section 4(6) of the Act."
calculatorModule: "retirement/gratuity-calculator.js"
...
eeat:
  ...
  dataSources:
    ...
    - "Income Tax Department (Section 10(10) Statutory Limits)"
advancedContent:
  definitionSnippet: "A Gratuity Calculator is an interactive retirement tool that computes statutory gratuity payouts, 5-year eligibility status, 15/26 working day formulas, and Section 10(10) ₹20 Lakh tax exemptions."
  proTips:
    - "Ensure you complete at least 4 years and 240 working days (approx 4 years 8 months) in a 5-day work week establishment to satisfy legal continuous service precedents."
    - "Reinvest tax-free gratuity lump sums into mutual funds and systematic withdrawal plans via our SWP Calculator."
    - "Ensure your last drawn Basic Salary + DA is accurately recorded on your final month pay slip before claiming gratuity."
  commonMistakes:
    - "Calculating gratuity using 30 calendar days instead of 26 statutory working days per month for covered establishment employees."
    - "Resigning at 4 years and 11 months assuming gratuity will be granted (statutory rule mandates full 5 years unless 240 days rule is legally proven)."
  glossaryTerms:
    - term: "Payment of Gratuity Act 1972"
      definition: "Indian federal legislation mandating terminal gratuity payments for employees in factories, mines, ports, railways, and commercial establishments."
    - term: "15/26 Working Days Rule"
      definition: "The statutory formula dividing monthly basic salary by 26 working days to compute 15 days of salary per year of service."
    - term: "Section 10(10)"
      definition: "Income Tax Act provision establishing the ₹20 Lakh tax-free ceiling on gratuity payouts."
---
...
1. **Last Drawn Monthly Basic Salary:** **₹50,000**
2. **Actual Tenure:** **15 Years, 7 Months**
3. **Rounded Service Years:** **16 Years** (since 7 months $\ge 6$ months)
4. **Mandatory 5-Year Threshold:** **Passed** (Eligible)
