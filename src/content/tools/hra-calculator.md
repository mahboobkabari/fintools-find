---
title: "HRA Calculator: House Rent Allowance Tax Exemption (Sec 10(13A))"
metaDescription: "Calculate House Rent Allowance (HRA) tax exemption online under Section 10(13A). Estimate exempt vs taxable HRA for Metro & Non-Metro cities accurately."
category: "tax"
categoryName: "Tax Calculators"
slug: "hra-calculator"
currency: "INR"
howToUse:
  - "Enter your annual Basic Salary + Dearness Allowance (DA) in Rupees (₹)."
  - "Enter the annual House Rent Allowance (HRA) received from your employer."
  - "Enter the total annual rent you actually pay to your landlord."
  - "Select whether you reside in a Metro city (Mumbai, Delhi, Kolkata, Chennai) or a Non-Metro city."
  - "Instantly review your total tax-exempt HRA under Section 10(13A) and remaining taxable HRA amount."
features:
...
faqs:
  - question: "What is House Rent Allowance (HRA) tax exemption?"
    answer: "House Rent Allowance (HRA) is a component of salary provided by employers to cover accommodation expenses. Under Section 10(13A) of the Income Tax Act, salaried employees living in rented accommodation can claim partial or full tax exemption on HRA."
  - question: "How is HRA tax exemption calculated under Rule 2A?"
    answer: "Under Rule 2A of the Income Tax Rules, HRA exemption is equal to the MINIMUM of three amounts: (1) Actual HRA received, (2) Rent paid minus 10% of basic salary, (3) 50% of basic salary for Metro cities (40% for Non-Metro cities)."
  - question: "Which cities qualify as Metro cities for 50% HRA calculation?"
    answer: "For Income Tax HRA calculations, only four cities qualify for the 50% basic salary ceiling: New Delhi, Mumbai, Kolkata, and Chennai. All other cities (including Bengaluru, Hyderabad, and Pune) are classified as Non-Metro (40% ceiling)."
  - question: "Is HRA exemption available under the New Tax Regime?"
    answer: "No. HRA tax exemption under Section 10(13A) is available ONLY under the Old Tax Regime. The default New Tax Regime (FY 2025-26) does not permit HRA exemptions."
  - question: "Is landlord PAN mandatory for claiming HRA tax exemption?"
    answer: "Yes. If total rent paid during a financial year exceeds ₹1,00,000 (₹8,333 per month), it is mandatory to provide the landlord's PAN number to your employer when filing Form 12BB."
  - question: "Can I pay rent to my parents and claim HRA exemption?"
    answer: "Yes. Salaried employees can pay rent to their parents and claim HRA tax exemption, provided the property is owned by the parents, a formal lease agreement exists, rent is transferred via bank channels, and parents report the rental income in their tax returns."
calculatorModule: "tax/hra-calculator.js"
publishDate: 2026-08-06
priority: "P0"
eeat:
  reviewedBy: "FinTool Engineering & Quant Team"
  methodology: "Calculations strictly execute Central Board of Direct Taxes (CBDT) Rule 2A formulation under Section 10(13A) of Income Tax Act, 1961."
  dataSources:
    - "Income Tax Department, Government of India (Section 10(13A) & Rule 2A Guidelines)"
    - "CBDT Circulars on Salaried Employee Allowances"
advancedContent:
  definitionSnippet: "An HRA Calculator is an interactive tax planning tool that computes tax-exempt House Rent Allowance (HRA) and taxable salary portions under Section 10(13A) Rule 2A."
  proTips:
  ...
  glossaryTerms:
    - term: "Section 10(13A)"
      definition: "The statutory provision of the Indian Income Tax Act granting tax exemption on House Rent Allowance paid to salaried renters."
    - term: "Rule 2A"
      definition: "The specific income tax rule detailing the 3-limit formula used to calculate exempt HRA."
    - term: "Form 12BB"
      definition: "The investment and allowance declaration form submitted by salaried employees to employers at year-end."
---
...
* **Homebuyers Evaluating Rent vs Buy:** To compare HRA tax benefits against home loan interest deductions under Section 24(b) using our [Home Loan Calculator](/tools/loans/home-loan-calculator/).
...
3. 50\% \text{ of Basic Salary (Metro)} \quad \text{OR} \quad 40\% \text{ of Basic Salary (Non-Metro)} 
\end{cases}$$
...
5. **Compare Old vs New Tax Regime:** Compare your total tax savings under the Old Regime (with HRA + 80C + 24b) against the New Tax Regime using our [Income Tax Calculator](/tools/tax/income-tax-calculator/).